        ...
        <div>
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white hover:text-gray-700 rounded-md shadow-lg group mb-20">
            ...
            {randomQuestion && (
              <p className='h-36 bg-white bg-opacity-50 font-black text-xl pt-3 rounded-2xl shadow-xl'>
                {randomQuestion.question}
              </p>
            )}

            {randomQuestion && (
              <p className='text-lg mt-4 shadow-md bg-white bg-opacity-5 rounded-full'>Autor: {randomQuestion.author} | Pregunta del módulo {randomQuestion.module}</p>
            )}
